...
ComplexNumber ComplexNumber::CalculatePower(double n) const
{
    ...
    double mod_of_result = std::pow(modulus, n);
...
// constructor of complex number just from the real part and the imaginary part is set to zero
...
// function to return the complex conjugate of complex number
ComplexNumber ComplexNumber::CalculateConjugate() const
{
    return ComplexNumber(mRealPart, -mImaginaryPart);
}

// the same but just for a void return type ? 
